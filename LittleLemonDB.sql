...
CREATE TABLE IF NOT EXISTS `LittleLemonDB`.`Orders` (
  ...
  `Customer_CustomerID` INT NOT NULL,
  `DeliveryStatus_DeliveryID1` INT NOT NULL,
  `Menu_MenuID` INT NOT NULL,
  PRIMARY KEY (`OrdersID`, `Customer_CustomerID`, `DeliveryStatus_DeliveryID1`, `Menu_MenuID`),
  INDEX `Booking_BookingID_idx` (`Booking_BookingID` ASC) VISIBLE,
  INDEX `fk_Orders_Customer1_idx` (`Customer_CustomerID` ASC) VISIBLE,
  INDEX `fk_Orders_DeliveryStatus1_idx` (`DeliveryStatus_DeliveryID1` ASC) VISIBLE,
  INDEX `fk_Orders_Menu1_idx` (`Menu_MenuID` ASC) VISIBLE,
  CONSTRAINT `Booking_BookingID`
  ...
  CONSTRAINT `Customer_CustomerID`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `DeliveryStatus_DeliverID`
    FOREIGN KEY (`DeliveryStatus_DeliveryID1`)
...
CREATE TABLE IF NOT EXISTS `LittleLemonDB`.`Staff` (
  ...
  `Customer_CustomerID` INT NOT NULL,
  PRIMARY KEY (`StaffID`, `Customer_CustomerID`),
